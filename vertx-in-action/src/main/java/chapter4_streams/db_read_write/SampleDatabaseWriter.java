 ...
 *
 * Uses a single buffer that is prepared wholly before writing it to the file, but could equally use a
 * buffer for the header and new buffers for each key/value entry.
 *
